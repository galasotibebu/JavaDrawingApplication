...
/**
 * Class for Lines that stores line coordinates and provides methods for
 * creating drawable line geometries for the ToolDrawPanel, or for
 * importing/exporting the line coordinates. Inherits from ObjectFundamenals.
 * 
 * @author
 */
public class LineFeature extends ShapesParent {
	...
	/**
	 * Adds the first point of the line as the first entry of the List of line
	 * elements
	 * 
	 * @author
	 * @param point
	...
	/**
	 * Adds the second point of the line as the first entry of the List of line
	 * elements
	 * 
	 * @author
	 * @param point
